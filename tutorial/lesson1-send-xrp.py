...
def standby_send_xrp():
    ...
    # Debugging: Check what response actually is
    ...
    try:
        ...
        result_data = response_json.get("result", response_json)  # Default to whole response if no 'result'
        
        text_standby_results.insert("1.0", json.dumps(result_data, indent=4))
    
    except json.JSONDecodeError:
        text_standby_results.insert("1.0", f"Invalid JSON response: {response}")
